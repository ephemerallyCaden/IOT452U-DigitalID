...
public class FineDiningConsole extends ConsoleUI {

    private final UseCaseRegistry registry;
    private final OrganisationContext context;
    private final List<MenuOption> menuOptions;

    public FineDiningConsole(TerminalMenu terminal, UseCaseRegistry registry,
    ...
    private List<MenuOption> buildMenu() {
        ...
        options.add(new MenuOption(4, "Verify with Cert History", ToolType.VERIFY_WITH_CERT_HISTORY));
        options.add(new MenuOption(5, "Verify with Attributes", ToolType.VERIFY_WITH_ATTRIBUTES));
        return options;
    }
    ...
    public void handleChoice(int choice) {
        try {
            switch (choice) {
                ...
                case 4: handleVerify(ToolType.VERIFY_WITH_CERT_HISTORY); break;
                case 5: handleVerify(ToolType.VERIFY_WITH_ATTRIBUTES); break;
