...
public class StreetVendorConsole extends ConsoleUI {

    private final UseCaseRegistry registry;
    private final OrganisationContext context;
    private final List<MenuOption> menuOptions;

    public StreetVendorConsole(TerminalMenu terminal, UseCaseRegistry registry,
    ...
    private List<MenuOption> buildMenu() {
        ...
        options.add(new MenuOption(4, "Verify with Permits", ToolType.VERIFY_WITH_PERMITS));
        return options;
    }
    ...
    public void handleChoice(int choice) {
        try {
            switch (choice) {
                ...
                case 4: handleVerify(ToolType.VERIFY_WITH_PERMITS); break;
