...
public class VerifyWithAttributesUseCase implements UseCase<VerifyWorkerRequest, VerificationResult> {
    ...
    public VerifyWithAttributesUseCase (
    ...
    public VerificationResult execute(VerifyWorkerRequest request) {
        ...
        VerificationResult result = verificationService.verifyWithAttributes(worker, certs);

        // Logging
        logger.log("VERIFY_WITH_ATTRIBUTES", reqWorkerId, "Worker", org);
