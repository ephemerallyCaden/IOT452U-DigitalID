...
public class VerifyWithCertHistoryUseCase implements UseCase<VerifyWorkerRequest, VerificationResult> {
    ...
    public VerifyWithCertHistoryUseCase (
    ...
    public VerificationResult execute(VerifyWorkerRequest request) {
        ...
        VerificationResult result = verificationService.verifyWithCertHistory(worker, certs);

        // Logging
        logger.log("VERIFY_WITH_CERT_HISTORY", reqWorkerId, "Worker", org);
